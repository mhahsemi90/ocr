...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.CharField(choices=[('person_management', 'مدیریت افراد'), ('person_detail', 'مشاهده جزئیات افراد'), ('person_create', 'ایجاد فرد جدید'), ('folder_management', 'مدیریت پوشه\u200cها'), ('document_upload', 'آپلود اسناد'), ('document_view', 'مشاهده اسناد'), ('document_content', 'مشاهده محتوای اسناد'), ('search_persons', 'جستجوی افراد'), ('search_documents', 'جستجوی اسناد'), ('ocr_processing', 'پردازش OCR'), ('user_management', 'مدیریت کاربران'), ('system_admin', 'مدیریت سیستم'), ('simple_ocr', 'دسترسی به OCR ساده')], max_length=50)),
